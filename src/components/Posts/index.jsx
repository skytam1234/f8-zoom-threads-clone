  ...
  return (
    <div className="w-full border-t border-border pb-4">
      ...
      <div className="grid grid-cols-[40px_1fr] grid-rows-[auto_auto_auto_auto_auto] gap-2 px-4 py-3">
        ...
        <div className="row-start-3 row-span-2 col-start-2 relative w-full mb-3  ">
          <div className="flex h-[280px] overflow-x-auto relative">
            {/* <div className="flex h-[280px]   overflow-x-auto g-10 absolute z-65 bg-amber-600">
              <div className="rounded-2xl mr-4 w-100  overflow-hidden ">
                <img
              ...
              <div className="rounded-2xl mr-4 overflow-hidden">
                <img
                  className="h-full object-cover"
                  src="https://noithatbinhminh.com.vn/wp-content/uploads/2022/08/anh-dep-21.jpg.webp"
                  alt="Anh"
                />
              </div>
            </div> */}
