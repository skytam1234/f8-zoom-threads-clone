...
export default function PostAvatar({ post, user }) {
        ...
        <>
            ...
            <div className="row-start-1 col-start-1 flex items-center justify-center">
                <div className="flex flex-row flex-wrap items-center  relative">
                    ...
                    <div
                        className="w-5 h-5  rounded-full absolute bottom-0 right-0 bg-black flex items-center justify-center hover:scale-[115%]"
                        onClick={() => {
                            if (currentUser) {
                                setIsOpen(true);
                            } else {
